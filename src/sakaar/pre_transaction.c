...
struct object_type pre_transaction_type = {PRE_TRANSACTION_OP, METHOD_GET_TLV NULL, METHOD_SET_TLV NULL};

struct pre_transaction *pre_transaction_new() {
    struct pre_transaction *res = skr_malloc(sizeof(struct pre_transaction));
